...
export default function DemoThemesPage() {
  ...
  // Array untuk merender katalog kartu sesuai image_b608bc.jpg
  ...
  return (
    <div className={`min-h-screen ${isOpen ? currentTheme.bgPage : 'bg-slate-50'} text-stone-800 flex flex-col items-center relative overflow-x-hidden font-sans transition-colors duration-300`}>
      ...
      {!isOpen ? (
        <div className="max-w-6xl w-full mx-auto px-4 py-8 space-y-6">
          ...
          {/* Tombol Navigasi Kembali ke Halaman User Dashboard */}
          <div className="flex justify-start">
            <button
              onClick={() => router.push('/user')}
              className="px-4 py-2 bg-teal-700 hover:bg-teal-800 text-white font-bold rounded-xl transition-all flex items-center gap-2 text-xs shadow-xs cursor-pointer"
            >
          ...
          {/* Filter Tipe Acara dengan Bentuk Tombol Sesuai image_b608bc.jpg */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
            {availableThemesInCard.map((theme) => (
              ...
              >
                ...
                {/* Frame Miniatur Sampul / Preview dengan gambar cover asli tema */}
                ...
                <div className="p-4 bg-white">
                  <button
                    ...
                    className="w-full py-2.5 bg-teal-700 hover:bg-teal-800 text-white font-bold text-xs tracking-wider rounded-xl transition-colors shadow-xs cursor-pointer"
                  >
                    Demo
                  </button>
                </div>
        ...
        <div className="w-full max-w-md flex flex-col gap-4 px-4 sm:px-0 py-6">
          ...
          <div className={`w-full bg-white p-6 border ${currentTheme.cardBorder} rounded-2xl shadow-sm space-y-8 pb-6 animate-in fade-in duration-300`}>
            ...
            <div id="ucapan" className="scroll-mt-4">
              <hr className="border-t-2 border-stone-300 mb-8" />
              <div className={`w-full p-5 ${currentTheme.formBg} rounded-2xl border ${currentTheme.cardBorder} text-center font-sans`}>
                <h2 className="text-sm font-bold text-stone-800">Doa dan Harapan (Preview Demo)</h2>
                <hr className="border-t border-stone-200/40 my-4" />
